...
- (void) setSpecificViews {
	self.headerBlockLabel.text = @"Сколько денег распределяется компанией в VIP PLUS договоре в Лидерской программе";
	...
	self.contentBlock3Label.text = @"2646€ - компания распределяет в Л.п.";
